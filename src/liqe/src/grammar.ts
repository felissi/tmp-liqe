...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "range$subexpression$1", "symbols": ["decimal"]},
    {"name": "range$subexpression$1", "symbols": ["unquoted_value"]},
    {"name": "range$string$1", "symbols": [{"literal":" "}, {"literal":"T"}, {"literal":"O"}, {"literal":" "}], "postprocess": (d) => d.join('')},
    {"name": "range$subexpression$2", "symbols": ["decimal"]},
    {"name": "range$subexpression$2", "symbols": ["unquoted_value"]},
    {"name": "range", "symbols": ["range_open", "range$subexpression$1", "range$string$1", "range$subexpression$2", "range_close"], "postprocess":  (data, start) => {
          return {
            location: {
              start,
            },
    ...
    {"name": "unquoted_value$ebnf$1", "symbols": ["unquoted_value$ebnf$1", /[a-zA-Z\.\-\u4E00-\u9FFF\d_*?@#$]/], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "unquoted_value", "symbols": [/[a-zA-Z\u4E00-\u9FFF\d_*?@#$]/, "unquoted_value$ebnf$1"], "postprocess": d => d[0] + d[1].join('')}
  ],
  ParserStart: "main",
};
